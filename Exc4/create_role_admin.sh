...
ROLE_NAME="general-all-admin"
VERBS_CSV="create,patch,update,delete,get,list,watch"
RESOURCES_CSV="services,endpoints,configmaps,secrets,persistentvolumes,persistentvolumeclaims,namespaces,nodes,serviceaccounts,
